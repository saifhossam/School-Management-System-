            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Parent first name</div>
                    <div class="col-lg-9 col-md-8"><?=$student['parent_fname']?></div>
                  </div>
                  
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Parent last name</div>
                    <div class="col-lg-9 col-md-8"><?=$student['parent_lname']?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Parent phone number</div>
